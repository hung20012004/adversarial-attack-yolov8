...
def set_seed(seed=0):
    ...
    với cùng tham số sẽ cho kết quả giống hệt nhau Tham số: seed (số nguyên): Giá trị hạt giống, mặc định là 0.
    """
...
class DCT4OD_mAP:
    ...
    def __init__(
        ...
        """Khởi tạo bộ tấn công Tham số: model: Mô hình YOLOv8 epsilon: Ngưỡng nhiễu tối đa (0-1 hoặc 0-255) chuẩn hóa
